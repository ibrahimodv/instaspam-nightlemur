...
__author__ = "NightLemur InstaSpam"
__license__ = "GPLv3"
__version__ = "1.5.0"
...
BANNER = """  
          Herhangi Bir Sorun Yaşıyorsanız "https://konyahackteam.blogspot.com/2020/01/termux-ile-instagram-spam-botu-yapma.html"
...
def Status(shit):
    print(Fore.WHITE +" Night" + Force.GREEN +"Lemur ~" + Style.RESET_ALL
    + " " + shit)
...
def DoitAnakin(reportedGuy,reportedGuyID,username,password,proxy):
    try:
        ...
        Fail(username,"Giriş yapılırken hata oluştu!\n Lütfen 'kullanicilar.txt' Dosyasını kontrol edin! ")
